...
The Elves take turns writing down the number of Calories contained by the various meals, snacks, rations, etc. that they've brought with them, _one item per line_. Each Elf _separates their own inventory from the previous Elf's inventory_ (if any) by _a blank line._
